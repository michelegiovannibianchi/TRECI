...
def extract_data_from_multiple_potential_dataset(case,V_to_do,round,folder_input,folder_output):
    ...
    for V_to_do_label,V in zip(V_to_do_labels,V_to_do):
        ...
        shutil.copy(f"{folder_input}/dataset_{V_to_do_label}_geom_{case}.xyz", f"{folder_output}/{V_to_do_label}/dataset_{V_to_do_label}_geom_{case}_round_{round}.xyz")
    ...
    shutil.copy(f"{folder_input}/dataset_PZC_geom_{case}.xyz", f"{folder_output}/PZC_label/dataset_PZC_geom_{case}_round_{round}.xyz")
